...
- Installers served from `https://clawdbot.ai/*`: live in the sibling repo `../clawdbot.ai` (`public/install.sh`, `public/install-cli.sh`, `public/install.ps1`).
...
- Docs are hosted on Mintlify (docs.clawdbot.ai).
- Internal doc links in `docs/**/*.md`: root-relative, no `.md`/`.mdx` (example: `[Config](/configuration)`).
- Section cross-references: use anchors on root-relative paths (example: `[Hooks](/configuration#hooks)`).
- Doc headings and anchors: avoid em dashes and apostrophes in headings because they break Mintlify anchor links.
- When Peter asks for links, reply with full `https://docs.clawdbot.ai/...` URLs (not root-relative).
- When you touch docs, end the reply with the `https://docs.clawdbot.ai/...` URLs you referenced.
- README (GitHub): keep absolute docs URLs (`https://docs.clawdbot.ai/...`) so links work on GitHub.
