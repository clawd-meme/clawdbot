...
**Clawdbot** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://clawdbot.ai) · [Docs](https://docs.clawdbot.ai) · [DeepWiki](https://deepwiki.com/clawdbot/clawdbot) · [Getting Started](https://docs.clawdbot.ai/start/getting-started) · [Updating](https://docs.clawdbot.ai/install/updating) · [Showcase](https://docs.clawdbot.ai/start/showcase) · [FAQ](https://docs.clawdbot.ai/start/faq) · [Wizard](https://docs.clawdbot.ai/start/wizard) · [Nix](https://github.com/clawdbot/nix-clawdbot) · [Docker](https://docs.clawdbot.ai/install/docker) · [Discord](https://discord.gg/clawd)
...
New install? Start here: [Getting started](https://docs.clawdbot.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.clawdbot.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.clawdbot.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.clawdbot.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.clawdbot.ai/start/getting-started)
...
Upgrading? [Updating guide](https://docs.clawdbot.ai/install/updating) (and run `clawdbot doctor`).
...
Details: [Development channels](https://docs.clawdbot.ai/install/development-channels).
...
Full security guide: [Security](https://docs.clawdbot.ai/gateway/security)
...
- **[Local-first Gateway](https://docs.clawdbot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.clawdbot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.clawdbot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.clawdbot.ai/nodes/voicewake) + [Talk Mode](https://docs.clawdbot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.clawdbot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.clawdbot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.clawdbot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.clawdbot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.clawdbot.ai/nodes).
- **[Onboarding](https://docs.clawdbot.ai/start/wizard) + [skills](https://docs.clawdbot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
- [Gateway WS control plane](https://docs.clawdbot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.clawdbot.ai/web), and [Canvas host](https://docs.clawdbot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.clawdbot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.clawdbot.ai/start/wizard), and [doctor](https://docs.clawdbot.ai/gateway/doctor).
- [Pi agent runtime](https://docs.clawdbot.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.clawdbot.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.clawdbot.ai/concepts/groups).
- [Media pipeline](https://docs.clawdbot.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.clawdbot.ai/nodes/audio).

### Channels

- [Channels](https://docs.clawdbot.ai/channels): [WhatsApp](https://docs.clawdbot.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.clawdbot.ai/channels/telegram) (grammY), [Slack](https://docs.clawdbot.ai/channels/slack) (Bolt), [Discord](https://docs.clawdbot.ai/channels/discord) (discord.js), [Google Chat](https://docs.clawdbot.ai/channels/googlechat) (Chat API), [Signal](https://docs.clawdbot.ai/channels/signal) (signal-cli), [iMessage](https://docs.clawdbot.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.clawdbot.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.clawdbot.ai/channels/msteams) (extension), [Matrix](https://docs.clawdbot.ai/channels/matrix) (extension), [Zalo](https://docs.clawdbot.ai/channels/zalo) (extension), [Zalo Personal](https://docs.clawdbot.ai/channels/zalouser) (extension), [WebChat](https://docs.clawdbot.ai/web/webchat).
- [Group routing](https://docs.clawdbot.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.clawdbot.ai/channels).

### Apps + nodes

- [macOS app](https://docs.clawdbot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.clawdbot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.clawdbot.ai/nodes/talk) overlay, [WebChat](https://docs.clawdbot.ai/web/webchat), debug tools, [remote gateway](https://docs.clawdbot.ai/gateway/remote) control.
- [iOS node](https://docs.clawdbot.ai/platforms/ios): [Canvas](https://docs.clawdbot.ai/platforms/mac/canvas), [Voice Wake](https://docs.clawdbot.ai/nodes/voicewake), [Talk Mode](https://docs.clawdbot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.clawdbot.ai/platforms/android): [Canvas](https://docs.clawdbot.ai/platforms/mac/canvas), [Talk Mode](https://docs.clawdbot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.clawdbot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.clawdbot.ai/tools/browser): dedicated clawdbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.clawdbot.ai/platforms/mac/canvas): [A2UI](https://docs.clawdbot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.clawdbot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.clawdbot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.clawdbot.ai/automation/cron-jobs); [webhooks](https://docs.clawdbot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.clawdbot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.clawdbot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.clawdbot.ai/concepts/channel-routing), [retry policy](https://docs.clawdbot.ai/concepts/retry), and [streaming/chunking](https://docs.clawdbot.ai/concepts/streaming).
- [Presence](https://docs.clawdbot.ai/concepts/presence), [typing indicators](https://docs.clawdbot.ai/concepts/typing-indicators), and [usage tracking](https://docs.clawdbot.ai/concepts/usage-tracking).
- [Models](https://docs.clawdbot.ai/concepts/models), [model failover](https://docs.clawdbot.ai/concepts/model-failover), and [session pruning](https://docs.clawdbot.ai/concepts/session-pruning).
- [Security](https://docs.clawdbot.ai/gateway/security) and [troubleshooting](https://docs.clawdbot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.clawdbot.ai/web) + [WebChat](https://docs.clawdbot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.clawdbot.ai/gateway/tailscale) or [SSH tunnels](https://docs.clawdbot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.clawdbot.ai/install/nix) for declarative config; [Docker](https://docs.clawdbot.ai/install/docker)-based installs.
- [Doctor](https://docs.clawdbot.ai/gateway/doctor) migrations, [logging](https://docs.clawdbot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.clawdbot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.clawdbot.ai/gateway)).
- **[Tailscale exposure](https://docs.clawdbot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.clawdbot.ai/gateway/remote)).
- **[Browser control](https://docs.clawdbot.ai/tools/browser)** — clawdbot‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.clawdbot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.clawdbot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.clawdbot.ai/nodes/voicewake) + [Talk Mode](https://docs.clawdbot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.clawdbot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.
...
Details: [Tailscale guide](https://docs.clawdbot.ai/gateway/tailscale) · [Web surfaces](https://docs.clawdbot.ai/web)
...
Details: [Remote access](https://docs.clawdbot.ai/gateway/remote) · [Nodes](https://docs.clawdbot.ai/nodes) · [Security](https://docs.clawdbot.ai/gateway/security)
...
Details: [Nodes](https://docs.clawdbot.ai/nodes) · [macOS app](https://docs.clawdbot.ai/platforms/macos) · [Gateway protocol](https://docs.clawdbot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.clawdbot.ai/concepts/session-tool)
...
Runbook: [iOS connect](https://docs.clawdbot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.clawdbot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.clawdbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.clawdbot/workspace/skills/<skill>/SKILL.md`.
...
[Full configuration reference (all keys + examples).](https://docs.clawdbot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.clawdbot.ai/gateway/security) · [Docker + sandboxing](https://docs.clawdbot.ai/install/docker) · [Sandbox config](https://docs.clawdbot.ai/gateway/configuration)

### [WhatsApp](https://docs.clawdbot.ai/channels/whatsapp)

- Link the device: `pnpm clawdbot channels login` (stores creds in `~/.clawdbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.clawdbot.ai/channels/telegram)
...
### [Slack](https://docs.clawdbot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.clawdbot.ai/channels/discord)
...
### [Signal](https://docs.clawdbot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.clawdbot.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.clawdbot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.clawdbot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.clawdbot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.clawdbot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.clawdbot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.clawdbot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.clawdbot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.clawdbot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.clawdbot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.clawdbot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.clawdbot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.clawdbot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.clawdbot.ai/platforms/windows), [Linux](https://docs.clawdbot.ai/platforms/linux), [macOS](https://docs.clawdbot.ai/platforms/macos), [iOS](https://docs.clawdbot.ai/platforms/ios), [Android](https://docs.clawdbot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.clawdbot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.clawdbot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.clawdbot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.clawdbot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.clawdbot.ai/gateway/pairing)
- [Remote gateway README](https://docs.clawdbot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.clawdbot.ai/web/control-ui)
- [Dashboard](https://docs.clawdbot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.clawdbot.ai/gateway/health)
- [Gateway lock](https://docs.clawdbot.ai/gateway/gateway-lock)
- [Background process](https://docs.clawdbot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.clawdbot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.clawdbot.ai/logging)

## Deep dives

- [Agent loop](https://docs.clawdbot.ai/concepts/agent-loop)
- [Presence](https://docs.clawdbot.ai/concepts/presence)
- [TypeBox schemas](https://docs.clawdbot.ai/concepts/typebox)
- [RPC adapters](https://docs.clawdbot.ai/reference/rpc)
- [Queue](https://docs.clawdbot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.clawdbot.ai/tools/skills-config)
- [Default AGENTS](https://docs.clawdbot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.clawdbot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.clawdbot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.clawdbot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.clawdbot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.clawdbot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.clawdbot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.clawdbot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.clawdbot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.clawdbot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.clawdbot.ai/platforms/ios)
- [Android node](https://docs.clawdbot.ai/platforms/android)
- [Windows (WSL2)](https://docs.clawdbot.ai/platforms/windows)
- [Linux app](https://docs.clawdbot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.clawdbot.ai/gmail-pubsub](https://docs.clawdbot.ai/automation/gmail-pubsub)

## Molty

Clawdbot was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [clawdbot.ai](https://clawdbot.ai)
...
This repository is a fork/derivative of **OpenClaw** by **Peter Steinberger** and OpenClaw contributors, released under the **MIT License**.  
See `LICENSE` for the full text, and `NOTICE.md` for upstream attribution.

This fork replaces upstream branding assets and is **not affiliated with or endorsed by** the upstream authors.  
See `TRADEMARKS.md` and `ASSETS_LICENSE.md` for additional context.
