...
import type { GatewayBindMode, GatewayTailscaleMode, ClawdbotConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.clawdbot.ai/gateway/tailscale", "https://docs.clawdbot.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
