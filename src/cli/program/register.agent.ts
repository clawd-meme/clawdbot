...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.clawdbot.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.clawdbot.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['clawdbot agents set-identity --agent main --name "Clawdbot" --emoji "🦞"', "Set name + emoji."],
  ["clawdbot agents set-identity --agent main --avatar avatars/clawdbot.png", "Set avatar path."],
  [
    "clawdbot agents set-identity --workspace ~/.clawdbot/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "clawdbot agents set-identity --identity-file ~/.clawdbot/workspace/IDENTITY.md --agent main",
