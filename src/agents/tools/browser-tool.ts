...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'Profiles: use profile="chrome" for Chrome extension relay takeover (your existing Chrome tabs). Use profile="clawdbot" for the isolated clawdbot-managed browser.',
