...
- Network path:
  ...
  - Tailnet via unicast DNS-SD (example domain: `clawdbot.internal.`), **or**
...
The Gateway advertises `_clawdbot-gw._tcp` on `local.`. The iOS app lists these automatically.

### Tailnet (cross-network)

If mDNS is blocked, use a unicast DNS-SD zone (choose a domain; example: `clawdbot.internal.`) and Tailscale split DNS.
