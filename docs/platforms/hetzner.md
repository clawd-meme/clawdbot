...
- Persist `~/.clawdbot` + `~/.clawdbot/workspace` on the host (survives restarts/rebuilds)
...
chown -R 1000:1000 /root/.clawdbot/workspace
```
...
CLAWDBOT_WORKSPACE_DIR=/root/.clawdbot/workspace
...
services:
  clawdbot-gateway:
    ...
    volumes:
      ...
      - ${CLAWDBOT_WORKSPACE_DIR}:/home/node/.clawdbot/workspace
    ports:
...
| Agent workspace     | `/home/node/.clawdbot/workspace/` | Host volume mount      | Code and agent artifacts         |
