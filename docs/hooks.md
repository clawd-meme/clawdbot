...
- **💾 session-memory**: Saves session context to your agent workspace (default `~/.clawdbot/workspace/memory/`) when you issue `/new`
...
homepage: https://docs.clawdbot.ai/hooks#my-hook
metadata:
...
**Output**: `<workspace>/memory/YYYY-MM-DD-slug.md` (defaults to `~/.clawdbot/workspace`)
