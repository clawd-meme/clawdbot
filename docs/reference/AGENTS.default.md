...
Clawdbot uses a dedicated workspace directory for the agent. Default: `~/.clawdbot/workspace` (configurable via `agents.defaults.workspace`).
...
```bash
cp docs/reference/templates/AGENTS.md ~/.clawdbot/workspace/AGENTS.md
cp docs/reference/templates/SOUL.md ~/.clawdbot/workspace/SOUL.md
cp docs/reference/templates/TOOLS.md ~/.clawdbot/workspace/TOOLS.md
```

3. Optional: if you want the personal assistant skill roster, replace AGENTS.md with this file:

```bash
cp docs/reference/AGENTS.default.md ~/.clawdbot/workspace/AGENTS.md
```
...
- For browser-driven verification, use `clawdbot browser` (tabs/status/screenshot) with the Clawdbot-managed Chrome profile.
