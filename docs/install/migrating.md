...
- Copy your **workspace** (`~/.clawdbot/workspace/` by default) — this includes your agent files (memory, prompts, etc.).
...
- `~/.clawdbot/workspace/` (recommended workspace)
...
tar -czf clawdbot-workspace.tgz .clawdbot/workspace
```
...
- your workspace (default `~/.clawdbot/workspace/`)
