...
### `docs.clawdbot.ai` shows an SSL error (Comcast/Xfinity)

Some Comcast/Xfinity connections block `docs.clawdbot.ai` via Xfinity Advanced Security.
Disable Advanced Security or add `docs.clawdbot.ai` to the allowlist, then retry.
