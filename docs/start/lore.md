...
For a while, the lobster was called **Clawd**, living in an **Clawdbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Clawdbot**.
...
In the end, **Clawdbot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.clawdbot/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Clawdbot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Clawdbot): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "clawdbot what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with clawdbot."
...
**The Great Clawdbot Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/clawdbot/clawdbot` ✅
- X handle `@clawdbot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.clawdbot.ai`
...
- **The whole Clawd Crew** pulled an all-nighter

**The Scammer Speedrun:** Crypto grifters launched a $CLAWDBOT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.

**New Traditions Born:**

- "The claw is the law" 🤠
- "Yee-claw"
- "Clawd abiding citizens"
- "Clawntroversy"

**Clawd → Moltbot → Clawdbot**
