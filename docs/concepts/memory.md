...
`~/.clawdbot/workspace`). See [Agent workspace](/concepts/agent-workspace) for the full layout.
...
Clawdbot can build a small vector index over `MEMORY.md` and `memory/*.md` (plus
