...
Clawdbot runs a single embedded agent runtime derived from **pi-mono**.
...
Clawdbot reuses pieces of the pi-mono codebase (models/tools), but **session management, discovery, and tool wiring are Clawdbot-owned**.
