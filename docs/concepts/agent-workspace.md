...
```bash
gh auth login
gh repo create clawdbot-workspace --private --source . --remote origin --push
```
...
1. Clone the repo to the desired path (default `~/.clawdbot/workspace`).
