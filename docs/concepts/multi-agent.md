...
- Workspace: `~/.clawdbot/workspace` (or `~/.clawdbot/workspace-<agentId>`)
...
- Workspace defaults to `~/.clawdbot/workspace` (or `~/.clawdbot/workspace-<profile>` when `CLAWDBOT_PROFILE` is set).
...
```json5
{
  agents: {
    list: [
      { id: "alex", workspace: "~/.clawdbot/workspace-alex" },
      { id: "mia", workspace: "~/.clawdbot/workspace-mia" },
    ],
  },
  bindings: [
    ...
    list: [
      {
        ...
        default: true,
        name: "Home",
        workspace: "~/.clawdbot/workspace-home",
    ...
    list: [
      {
        id: "chat",
        name: "Everyday",
        workspace: "~/.clawdbot/workspace-chat",
        model: "anthropic/claude-sonnet-4-5",
      },
      {
        id: "opus",
        name: "Deep Work",
        workspace: "~/.clawdbot/workspace-opus",
