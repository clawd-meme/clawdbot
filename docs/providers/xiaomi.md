---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Clawdbot"
read_when:
  - You want Xiaomi MiMo models in Clawdbot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Clawdbot uses
...
```bash
clawdbot onboard --auth-choice xiaomi-api-key
# or non-interactive
clawdbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
