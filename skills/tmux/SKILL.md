...
```bash
SOCKET_DIR="${CLAWDBOT_TMUX_SOCKET_DIR:-${CLAWDBOT_TMUX_SOCKET_DIR:-${TMPDIR:-/tmp}/clawdbot-tmux-sockets}}"
mkdir -p "$SOCKET_DIR"
...
- Use `CLAWDBOT_TMUX_SOCKET_DIR` (legacy `CLAWDBOT_TMUX_SOCKET_DIR` also supported).
