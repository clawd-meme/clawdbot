...
const compilerOverride = env.CLAWDBOT_TS_COMPILER ?? env.CLAWDBOT_TS_COMPILER;
...
const runNode = () => {
  const nodeProcess = spawn(process.execPath, ["clawdbot.mjs", ...args], {
    cwd,
    env,
    stdio: "inherit",
  });
