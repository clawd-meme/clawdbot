...
CLAWDBOT_WORKSPACE_DIR="${CLAWDBOT_WORKSPACE_DIR:-$HOME/.clawdbot/workspace}"

mkdir -p "$CLAWDBOT_CONFIG_DIR"
mkdir -p "$CLAWDBOT_WORKSPACE_DIR"

export CLAWDBOT_CONFIG_DIR
export CLAWDBOT_WORKSPACE_DIR
...
export CLAWDBOT_EXTRA_MOUNTS="$EXTRA_MOUNTS"
export CLAWDBOT_HOME_VOLUME="$HOME_VOLUME_NAME"
...
echo "Docs: https://docs.clawdbot.ai/providers"
