...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.clawdbot", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.clawdbot", category: "gateway-endpoint")
