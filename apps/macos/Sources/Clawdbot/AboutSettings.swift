...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            VStack(alignment: .center, spacing: 6) {
                ...
                AboutLinkRow(icon: "globe", title: "Website", url: "https://clawdbot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "ClawdbotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "ClawdbotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ClawdbotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ClawdbotGitCommit") as? String) ??
            "unknown"
    }
