...
Clawdbot is a labor of love. There is no bug bounty program and no budget for paid reports. Please still disclose responsibly so we can fix issues quickly.
The best way to help the project right now is by sending PRs.

## Out of Scope

- Public Internet Exposure
- Using Clawdbot in ways that the docs recommend not to
...
- `https://docs.clawdbot.ai/gateway/security`
