...
describe("diagnostics-otel service", () => {
  ...
  test("records message-flow metrics and spans", async () => {
    ...
    expect(
      telemetryState.histograms.get("clawdbot.webhook.duration_ms")?.record,
    ).toHaveBeenCalled();
    ...
    expect(
      telemetryState.histograms.get("clawdbot.message.duration_ms")?.record,
    ).toHaveBeenCalled();
    ...
    expect(
      telemetryState.histograms.get("clawdbot.session.stuck_age_ms")?.record,
    ).toHaveBeenCalled();
